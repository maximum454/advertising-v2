...
gulp.task('html:build', function () {
    gulp.src(ma.src.html)
        .pipe(plugins.rigger())
        .pipe(gulp.dest(ma.build.html))
...
gulp.task('watch', function(){
    plugins.watch([ma.watch.html], function(event, cb) {
        gulp.start('html:build');
    });
    plugins.watch([ma.watch.style], function(event, cb) {
        gulp.start('style:build');
    });
    plugins.watch([ma.watch.js], function(event, cb) {
        gulp.start('js:build');
    });
    plugins.watch([ma.watch.img], function(event, cb) {
        gulp.start('image:build');
    });
    plugins.watch([ma.watch.fonts], function(event, cb) {
